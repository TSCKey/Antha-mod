package net.tsckey.dodo.entity.custom;
...
public class AnthaStaffProjectileEntity extends PersistentProjectileEntity {
    private float rotation;
    public Vector2f groundedOffset;
    public AnthaStaffProjectileEntity(EntityType<? extends PersistentProjectileEntity> entityType, World world) {
        super(entityType, world);
    }
    public AnthaStaffProjectileEntity(World world, PlayerEntity player) {
        super(ModEntities.Antha_Staff,player,world,new ItemStack(ModItems.Antha_Staff),null);
    }
    @Override
    protected ItemStack getDefaultItemStack() {
        return new ItemStack(ModItems.Antha_Staff);
    }
